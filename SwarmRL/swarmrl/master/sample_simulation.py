...
com_force_rule = models.dummy_models.ToCenterMass(1000, vision_angle=np.pi/2.)

ureg = pint.UnitRegistry()
params = engine.espresso.MDParams(n_colloids=10,
                                  ureg=ureg,
...
system_runner = engine.espresso.EspressoMD(params, seed=42, out_folder=output_folder, write_chunk_size=1000)
