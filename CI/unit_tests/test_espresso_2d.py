...
class EspressoTest2D(ut.TestCase):
    ...
    def test_class(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            runner = espresso.EspressoMD(params, n_dims=2, out_folder=temp_dir, write_chunk_size=1)
            ...
            np.testing.assert_array_almost_equal(directors_z, np.zeros_like(directors_z))
            ...
            np.testing.assert_array_almost_equal(directors_new_z, np.zeros_like(directors_new_z))
